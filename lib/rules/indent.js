    ...
    create(context) {
        ...
        function addElementListIndent(tokens, elements, offset) {
            ...
            elements.slice(1).forEach((element, index) => {
                ...
                if (offset === "first") {
                    ...
                    const firstTokenOfPreviousElement = previousElement && sourceCode.getFirstToken(previousElement);
                    const lastTokenOfPreviousElement = previousElement && sourceCode.getLastToken(previousElement);

                    if (previousElement && previousElement.loc.end.line > tokens[0].loc.end.line) {
                        matchIndentOf(firstTokenOfPreviousElement, sourceCode.getFirstToken(element));
                    }
                }
            });
        ...
        */
        function addFunctionCallIndent(node) {
            ...
            addElementListIndent(tokens, node.arguments, options.CallExpression.arguments || 0);
